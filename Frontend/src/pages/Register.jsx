      ...
      <div className="rounded-xl border border-[var(--brand-outline)] bg-card/95 p-8 shadow-[0_4px_24px_rgba(74,52,38,0.08)] backdrop-blur-sm">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--brand-brown-light)] py-3 text-sm font-semibold text-white dark:text-gray-900 transition-colors hover:bg-[var(--brand-brown)] disabled:cursor-not-allowed disabled:opacity-70"
          >
            {loading ? (
              <>
