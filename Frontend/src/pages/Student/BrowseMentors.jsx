  ...
  return (
    <div className="mx-auto flex w-full min-w-0 max-w-[1440px] flex-col gap-4 pb-10 sm:gap-6 sm:pb-12 md:gap-8">
      ...
      <form
        ...
        className="grid grid-cols-1 gap-3 rounded-xl border border-[var(--brand-outline)] bg-card p-3 shadow-sm sm:p-4 md:grid-cols-[minmax(0,1fr)_160px_auto]"
      >
        <input
          type="text"
          value={keyword}
          ...
          className="min-w-0 w-full rounded-lg bg-card text-card-foreground border border-[var(--brand-outline)] px-4 py-2.5 text-sm outline-none focus:border-[var(--brand-teal)] md:col-span-1"
        />
        <select
          value={sortBy}
          onChange={(e) => setSortBy(e.target.value)}
          className="min-w-0 w-full rounded-lg bg-card text-card-foreground border border-[var(--brand-outline)] px-4 py-2.5 text-sm outline-none focus:border-[var(--brand-teal)]"
        >
        ...
        <button
          type="submit"
          className="w-full rounded-lg bg-[var(--brand-brown-light)] px-6 py-2.5 text-sm font-semibold text-white dark:text-gray-900 hover:bg-[var(--brand-brown)] md:w-auto"
        >
          Search
        </button>
      </form>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-4 min-w-0 sm:grid-cols-2 sm:gap-5 xl:grid-cols-3">
          {mentors.map((mentor) => (
            <article
              key={getId(mentor)}
              className="flex min-w-0 flex-col gap-3 rounded-xl border border-[var(--brand-outline)] bg-card p-4 shadow-sm transition-shadow hover:shadow-md sm:p-5"
            >
              ...
              <Link
                ...
                className="mt-auto w-full rounded-lg border border-[var(--brand-brown-light)] dark:border-[var(--brand-teal)] py-2.5 text-center text-sm font-bold text-[var(--brand-brown-light)] dark:text-[var(--brand-teal)] transition-colors hover:bg-[var(--brand-brown-light)] dark:hover:bg-[var(--brand-teal)] hover:text-white dark:hover:text-white"
              >
                View Profile
              </Link>
            </article>
